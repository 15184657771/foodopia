...
- (void)initData{
    self.titleNormalColor = RGB(74, 74, 74);
    self.titleSelectedColor = RGB(69, 183, 255);
    self.selectedIndex = 0;
    self.titleFont = [UIFont systemFontOfSize:14.f];
    self.indicatorColor = RGB(69, 183, 255);
    self.indicatorHeight = 3.f;
    self.indicatorExtraW = -10.f;
