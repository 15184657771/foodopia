...
//    UITabBarController *tabBarViewController = [[UITabBarController alloc] init];
    ...
    nav.tabBarItem = [[UITabBarItem alloc] initWithTitle:@"风景" image:nil tag:0];
    nav.hidesBottomBarWhenPushed = YES;
    
    // 初始化XYSideViewController 设置为window.rootViewController
    XYSideViewController *rootViewController = [[XYSideViewController alloc] initWithSideVC:leftViewController currentVC:nav];
